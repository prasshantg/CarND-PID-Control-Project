...
/**
 * Used https://udacity-reviews-uploads.s3.amazonaws.com/_attachments/41330/1493863065/pid_control_document.pdf
 * as reference
 */
int main()
{
  ...
  steer_pid.Init(0.04, 0.0001, 4.0);
  speed_pid.Init(2.0, 0, 0.02);
...
//          speed_value = 0.3 - speed_pid.TotalError();
          speed_value = 0.3;
